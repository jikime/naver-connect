// 격차 리포트 — 한빛구 셸(FR-GR-01/03) + 연결맵·지역 맵 토글(FR-GR-02/04, T-020) + 기회카드(FR-GR-05/06/07).
// 근거: ARCHITECTURE.md §3(L2 GapReport), TASKS.md T-017/T-018/T-019/T-020, ADR-02/ADR-04
//
